...
<p align="center">
  <img src="assets/logo.svg" alt="javadev logo" width="140" />
</p>

<h1 align="center">javadev</h1>

<p align="center">
  Portable, hardened Java 21+ development container with TMUX IDE,
  Model Context Protocol (MCP) AI agent tooling, Maven, Gradle, JDTLS, mobile WebTTY, and dotfiles bootstrap.
</p>

<p align="center">
  <a href="https://github.com/sebastienrousseau/javadev/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/sebastienrousseau/javadev/ci.yml?style=for-the-badge&logo=github" alt="Build" /></a>
...
Clone this repository and spin up a complete, hardened Java terminal IDE in seconds:
...
`javadev` is the Java member of the [`langdev`](https://github.com/sebastienrousseau/langdev) suite:
...
- **Center-Top (56% W, 70% H)**: Editor pane loaded with Neovim and JDTLS.
- **Center-Bottom (56% W, 30% H)**: Integrated bash terminal with JDK and Maven/Gradle on PATH.
