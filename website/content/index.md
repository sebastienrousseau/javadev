...
language: "en-GB"
date: "2026-08-29"
description: "Enterprise-grade Java container preloaded with OpenJDK 21, Maven, Gradle, JDTLS, 4-pane TMUX IDE, and stdio MCP server."
eyebrow: "Java Stack"
...
<section id="overview" class="section">
  <div class="container text-center">
    <h2 class="section-title">Engineered for Java Developers & Terminal AI Agents</h2>
    <p class="section-desc">Enterprise-grade Java runtime powered by OpenJDK 21, Eclipse JDTLS, and native MCP container tooling.</p>
    <div class="grid-2x2">
      <div class="card">
        <h3>Java 21+ Toolchain</h3>
        <p>Pre-installed with OpenJDK 21, Gradle, Apache Maven, and Eclipse JDT Language Server (JDTLS).</p>
      </div>
      <div class="card">
        <h3>4-Pane TMUX IDE (Prefix + i)</h3>
        <p>Dedicated split layout with File Tree Explorer, Neovim (JDTLS + Treesitter), bash shell, and AI Agent pane.</p>
      </div>
      <div class="card">
      ...
      <div class="card">
        ...
        <p>Stdio JSON-RPC 2.0 interface exposing Maven/Gradle test execution and repository diagnostics to Claude Code and Cursor.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="features" class="section">
  <div class="container text-center">
    ...
    <p class="section-desc">A terminal-first Java 21+ environment with the
    ...
    <div class="ide-layout">
      ...
      <div class="ide-center">
        <div class="ide-pane ide-editor">
          ...
          <p>Editor pane loaded with Neovim and JDTLS.</p>
        </div>
        <div class="ide-pane ide-terminal">
          <h3>Center-Bottom (56% W, 30% H)</h3>
          <p>Integrated bash terminal with JDK and Maven/Gradle on PATH.</p>
        </div>
      </div>
  ...
  <div class="container narrow">
    ...
    <div class="faq-stack">
      ...
      <div class="card">
        ...
        <p>Under 500 milliseconds. JVM and JDTLS launcher are pre-baked at image build time.</p>
      </div>
    </div>
  </div>
</section>
